...
const Dashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      toast.error("haah", error.message)
    }
  }
  ...
  return (
    <div>
      <Title
        ...
        title={"Dashboard"}
        subTitle={
          "Monitor your room listings, track bookings and analyze revenue-all in one place. Stay update with real-time insights to ensure smooth operations."
        }
      />
      ...
      <div className="w-full max-w-3xl text-left border border border-gray-300 rounded-lg max-h-80 overflow-y-scroll">
