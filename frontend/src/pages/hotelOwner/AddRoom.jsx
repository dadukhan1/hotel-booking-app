...
const AddRoom = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      const amentities = Object.keys(inputs.amenities).filter(key => inputs.amenities[key]);
      formData.append('amenities', JSON.stringify(amentities));
  ...
  return (
    <form onSubmit={onSubmitHandler}>
      <Title
        ...
        title={"Add Room"}
        subTitle={
          "Fill in the details carefully and accurate room details, pricing, and amentities, to enhance the user booking experience"
        }
      />
